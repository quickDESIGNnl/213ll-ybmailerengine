...
class SettingsPage {
    ...
    private function render_test_actions(): void {
        ...
        <div class="gem-mailer-test-actions">
            ...
            <p><?php esc_html_e( 'Gebruik deze knoppen om direct een testmail naar je eigen beheerdersadres te sturen.', 'gem-mailer' ); ?></p>
            <p class="gem-mailer-test-buttons">
                ...
                <a class="button button-secondary" href="<?php echo esc_url( $this->testMailer->url( 'topic-reaction' ) ); ?>">
                    <?php esc_html_e( 'Test: reactie op onderwerp', 'gem-mailer' ); ?>
                </a>
                <a class="button button-secondary" href="<?php echo esc_url( $this->testMailer->url( 'reaction-reply' ) ); ?>">
                    <?php esc_html_e( 'Test: reactie op reactie', 'gem-mailer' ); ?>
                </a>
            </p>
        </div>
        <?php
    ...
    private function current_notice(): ?array {
        ...
        if ( 'sent' === $status ) {
            $labels = [
                ...
                'topic-reaction'  => __( 'Testmail voor een reactie op een onderwerp is verzonden naar je eigen e-mailadres.', 'gem-mailer' ),
                'reaction-reply'  => __( 'Testmail voor een reactie op een reactie is verzonden naar je eigen e-mailadres.', 'gem-mailer' ),
            ];
